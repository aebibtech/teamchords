    ...
    return (
        <div className="bg-gray-100">
            ...
            <div className="flex flex-col items-center">
                ...
                {outputs.map((output) => (
                    <div key={output.id} className="mt-4 bg-white shadow-lg rounded-lg p-6 max-w-3xl w-full border border-gray-200">
                        <pre className="font-sans text-sm md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">{renderChordPro(output.chordsheets.content, output.chordsheets.key, output.targetKey)}</pre>
                    </div>
                ))}
            </div>
